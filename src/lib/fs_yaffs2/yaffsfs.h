...
int yaffs_stat(const YCHAR *path, struct stat *buf) ;
int yaffs_lstat(const YCHAR *path, struct stat *buf) ;
...
int yaffs_stat_reldir(struct yaffs_obj *reldir, const YCHAR *path, struct stat *buf);
int yaffs_lstat_reldir(struct yaffs_obj *reldir, const YCHAR *path, struct stat *buf);
...
int yaffs_rename_reldev(struct yaffs_dev *dev,
			const YCHAR *oldPath, const YCHAR *newPath);
int yaffs_stat_reldev(struct yaffs_dev *dev, const YCHAR *path, struct stat *buf);
int yaffs_lstat_reldev(struct yaffs_dev *dev, const YCHAR *path, struct stat *buf);
